...
ActiveRecord::Schema[8.0].define(version: 2025_11_10_171034) do
  ...
  create_table "event_organizational_roles", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["event_id", "organizational_role_id"], name: "index_event_org_roles_on_event_and_role", unique: true
