...
RSpec.describe "AdminPanel::Events", type: :request do
  ...
  describe "GET /index" do
    ...
    it "displays events correctly" do
      ...
      event1 = Event.create!(title: "Event 1", event_date: 1.day.from_now, description: "Test", location: "Test", capacity: 50)
      event2 = Event.create!(title: "Event 2", event_date: 2.days.from_now, description: "Test", location: "Test", capacity: 50)
  ...
  describe "GET /show" do
    let(:event) { Event.create!(title: "Test Event", event_date: 1.day.from_now, description: "Test", location: "Test", capacity: 50) }
  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new event and redirects" do
        event_params = { event: { title: "Test Event", description: "Test", event_date: 1.day.from_now, location: "Test Location", capacity: 50 } }
